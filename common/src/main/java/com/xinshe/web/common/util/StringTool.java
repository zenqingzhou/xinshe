...
public class StringTool {
    ...
    public static String replace(String ori,Integer start,Integer end){
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(ori.substring(0,start));
        for(int index=1;index<(end-start);index++){
            stringBuilder.append("*");
        }
        stringBuilder.append(ori.substring(end));
     ...
     * @return
     */
    public static Integer getInteger(Object message) {
    ...
    public static boolean isNotEmptyTwo(Object o) {
        if (o != null){
     ...
     * @return 排序后的字符串
     */
    public static String packageSupSign(HashMap<String, String> hash, String partnet_key,
                                        String supUser_key) {
        ...
        System.out.println("sign------------------------" + buffer.toString() + partnet_key
                           + supUser_key);
        // 返回签名串
    ...
    public static String urlParameters(HashMap<String, String> hash) {
        ...
        if (null != hash) {
            ...
            while (it.hasNext()) {
                ...
                String value = hash.get(key);
                if (StringTool.isNotEmpty(value)) {
                    buffer.append(key + "=" + StringTool.parameterEncode(value, "GBK") + "&");
                }
     ...
     */
    public static String getObjToString(String[] objs) {
